...
void main() {
  ...
  group('RandomPhotoUtil Probability Test', () {
    ...
    test(
        'getRandomWeighted should return null when given invalid formatted data',
        () {
      List<String> testData = [
    ...
    test(
      ...
      if (result != null) {
        print(
            "Selected photo: ID=${result.id}, Code=${result.code}, Path=${result.path}");
      } else {
    ...
    test('getRandomWeighted should select higher weight items more frequently',
      ...
      final sortedMap = Map.fromEntries(
        selectionCounts.entries.toList()
